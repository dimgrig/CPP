...
#include "wizard/shared_defs.h"
#include "wizard/intropage.h"
#include "wizard/middlepage.h"
#include "wizard/finalpage.h"
...
void MainWindow::connect_signal_slot() {
    ...
    connect(this->ui->pb_wizard, &QPushButton::clicked, this, &MainWindow::wizard);
}
