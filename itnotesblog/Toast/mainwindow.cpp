...
void MainWindow::connect_signal_slot() {
    ...
    connect(this->ui->pb_ok, &QPushButton::clicked, [this](){
        this->toast->show_toast("Ok", "Ok");
    });

    connect(this->ui->pb_ok_large, &QPushButton::clicked, [this](){
        this->toast->show_toast("Устанавливаем переданный текст message в m_lblToast; \
    ...
    connect(this->ui->pb_warning, &QPushButton::clicked, [this](){
        this->toast->show_toast("Warning message", "Warning");
    });

    connect(this->ui->pb_error, &QPushButton::clicked, [this](){
        this->toast->show_toast("Error message", "Error");
    });

    connect(this->ui->pb_wait, &QPushButton::clicked, [this](){
        this->toast->show_toast("Wait message", "Wait");
    });
}
