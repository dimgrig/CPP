...
//    //std::locale::global(std::locale(std::locale("ru_RU"), "C", std::locale::numeric));
...

    {
        ...
        QString text = "Это пример текста, который будет экспортирован в .docx файл. "
                       "Текст текст текст текст текст текст. "
                       "Текст текст текст текст текст текст. "
                       "Текст текст текст текст текст текст. "
                       "Текст текст текст текст текст текст. \n"
                       "Это пример второго абзаца текста.\n"
                       "Это пример перечисления:\n"
                       "- перечисление 1;\n"
                       "- перечисление 2.\n"
                       "Это пример еще одного абзаца. "
                       "Текст текст текст текст текст текст. "
                       "Текст текст текст текст текст текст. "
                       "Текст текст текст текст текст текст. "
                       "Текст текст текст текст текст текст. "
